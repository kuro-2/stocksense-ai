  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        ...
        <form onSubmit={handleAdd} className="bg-white border border-slate-200 rounded-xl p-4 mb-6 flex flex-wrap items-end gap-3">
          ...
          <div>
            ...
            <input
              ...
              className="border border-slate-200 rounded-lg px-3 py-2 text-sm w-32 focus:outline-none focus:border-blue-400"
            />
          </div>
          <button
            ...
            <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm divide-y divide-slate-100">
              {activeAlerts.map(a => (
                <div key={a.id} className="flex items-center justify-between px-4 py-3">
                  <div>
                    <p className="font-semibold text-slate-900">{a.symbol}</p>
                    <p className="text-xs text-slate-400">{a.stockName}</p>
                  </div>
        ...
        {!loading && triggeredAlerts.length > 0 && (
          <div>
            <h2 className="text-sm font-semibold text-slate-700 mb-2">Triggered</h2>
            <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm divide-y divide-slate-100">
